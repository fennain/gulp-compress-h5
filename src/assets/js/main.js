 ...
 */
//定义全局需要的变量
var can1, can2, can4;     //背景和游戏2个CANVAS对象
var ctx1, ctx2, ctx4;     //2个CANVAS绘图环境
...
cover_image.src = "assets/imgs/cover.png";

var playIcon = new Image();
playIcon.src = "assets/imgs/play.png";

var pause_image = new Image();
pause_image.src = "assets/imgs/pause.png";

var play = false;

document.body.onload = cover;    //主函数
